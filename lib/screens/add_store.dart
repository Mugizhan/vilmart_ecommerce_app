...
class _StoreDetailsState extends State<StoreDetails> {
  LatLng selectedLocation = LatLng(10.0, 78.0);
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: BlocBuilder<ShopRegisterBloc, ShopRegisterState>(
  builder: (context, state) {
     int selectedIndex=state.categoryIndex;
    return Container(
          ...
          children: [
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'City',
                  errorText: state.isAddress?null:"Enter the City",
                  fillColor: Colors.grey[50],
                  filled: true,
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'State',
                  errorText: state.isAddress?null:"Enter the State",
                  fillColor: Colors.grey[50],
                  filled: true,
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Country',
                  errorText: state.isAddress?null:"Enter the Country",
                  fillColor: Colors.grey[50],
                  filled: true,
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'GST Number',
                  errorText: state.isEmail?null:"Enter the valid Gst number",                  fillColor: Colors.grey[50],
                  filled: true,
  ...
  Widget buildCategoryTile({required int index, required String label, required String image}) {
    ...
    print("event.index:${context.read<ShopRegisterBloc>().state.categoryIndex}");
